...
})({"dxh78":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "9df4d40c235eaf5e";
"use strict";
...
if (logoutBtn) {
    ...
    logoutBtn.addEventListener('click', (e)=>{
        ...
        (0, _login.logout)(); // Call your imported logout function
    });
} else console.log("Logout button NOT found.");

},{"./login":"7yHem","@babel/polyfill":"dTCHC"}],"7yHem":[function(require,module,exports,__globalThis) {
...
const logout = async ()=>{
    try {
        ...
        if (response.status == 200) {
            (0, _alert.showAlert)('success', 'logout successfull');
            ...
            try {
                ...
                console.warn('--- logout() FAILED (non-200), could not parse JSON error ---'); // ADD THIS
            }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./alert":"kxdiQ"}],"gkKU3":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dTCHC":[function(require,module,exports,__globalThis) {
"use strict";
...
},{}]},["dxh78","f2QDv"], "f2QDv", "parcelRequire11c7")
